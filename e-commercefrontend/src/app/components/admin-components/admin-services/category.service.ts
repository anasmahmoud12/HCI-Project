...
import { CategoryResponse } from '../admin-models/category.model';

import { CategoryFormData } from '../admin-models/category.model';
  ...
  // }
   createCategoryWithImage(categoryData: CategoryFormData): Observable<any> {
    ...
    getCategories(): Observable<CategoryResponse[]> {
      return this.http.get<CategoryResponse[]>('http://localhost:8080/api/categories');
    }
